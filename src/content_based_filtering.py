...
def train_transformer(data):
    ...
    joblib.dump(transformer, "data/models/transformer.joblib")
...
def transform_data(data):
    ...
    transformer = joblib.load("data/models/transformer.joblib")
...
def main(data_path):
    ...
    save_transformed_data(transformed_data,"data/models/transformed_data.npz")
